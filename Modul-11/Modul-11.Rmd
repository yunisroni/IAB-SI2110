...
# Import Data
data yang digunakan adalah dataset diabetes.csv. Dataset ini berisikan beberapa variabel yaitu: data pregnancies, glucose, blood pressure, skinfold, insulin, BMI, diabetes pedigree, age, dan outcome
...
glimpse(data)
```
Bisa dilihat bahwa 8 buah variabel bertipe data numerik dan ada 1 variabel (`Outcome`) yang bertipe katerikaln (kategorik). Kita amsumsikan 1 = Yes, dan 0 = No
